...
namespace OpenRA.Mods.Bam.BamWidgets
{
    public class DrawTransformStatisticsWidget : Widget
    {
        ...
        private TransformOnIdle transformAfterTime;
        private TransformOnIdleInfo transformAfterTimeInfo;
        ...
        public override void Draw()
        {
            ...
            transformAfterTime = actorActions.Actor.TraitOrDefault<TransformOnIdle>();
            transformAfterTimeInfo = actorActions.Actor.Info.TraitInfoOrDefault<TransformOnIdleInfo>();
            ...
            var progress = 8 * transformAfterTime.Ticker / transformAfterTimeInfo.Delay;
