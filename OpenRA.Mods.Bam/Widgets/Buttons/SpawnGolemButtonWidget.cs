...
namespace OpenRA.Mods.Bam.BamWidgets.Buttons
{
    public class SpawnGolemWidget : Widget
    {
        ...
        public override void Tick()
        {
            ...
            if (actorActions.Actor.Info.HasTraitInfo<SpawnActorInfo>())
                actorString = actorActions.Actor.Info.TraitInfo<SpawnActorInfo>().Actor;
        ...
        public override bool HandleMouseInput(MouseInput mi)
        {
            ...
            {
                actorActions.Actor.World.IssueOrder(new Order("SpawnActor", actorActions.Actor, false));
                pressed = true;
            }
