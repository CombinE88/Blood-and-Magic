    ...
    public class ManaCounterWidget : Widget
    {
        ...
        public override void Draw()
        {
            ...
            bamUi.FontRegular.DrawTextWithContrast(manaText,
                new float2(RenderBounds.X + RenderBounds.Width - bamUi.FontRegular.Measure(manaText).X - 2, RenderBounds.Y + RenderBounds.Height / 2 - bamUi.FontRegular.Measure(manaText).Y / 2),
                Color.LawnGreen,
                Color.Black, 1);

            bamUi.FontRegular.DrawTextWithContrast(manaValue,
                new float2(RenderBounds.X + RenderBounds.Width - bamUi.FontRegular.Measure(manaText).X - bamUi.FontRegular.Measure(manaValue).X - 4, RenderBounds.Y + RenderBounds.Height / 2 - bamUi.FontRegular.Measure(manaValue).Y / 2),
                Color.Yellow,
                Color.Black, 1);
